...
define('G5_MYSQL_USER', 'must_db_user');
define('G5_MYSQL_PASSWORD', 'mustdbpass');
define('G5_MYSQL_DB', 'must_db');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '01c919416e0ab5bbe0d76f2ef4096b56'); // 토큰 암호화에 사용할 키
